...
class ProductRepositoryRelationalDatabase(private val reactiveProductRepository: ReactiveProductRepository) : ProductRepository {
    override suspend fun getProductById(id: Int): Product? = reactiveProductRepository.getProductById(id).awaitFirstOrNull()
    ...
    override fun getAllProducts(): Flow<Product> = reactiveProductRepository.getAllProducts().asFlow()
}
